      ...
      <section className="py-16 section-theme-light relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
            ...
            {/* Category Filter Pills (Arrow buttons removed) */}
          ...
          <div className="flex flex-wrap items-center justify-center gap-2.5 mb-14">
            {servicesData.map((svc) => {
              ...
              return (
                <button
                  key={svc.id}
                  onClick={() => navigate(svc.slug || svc.id)}
            ...
            >
              ...
              <div>
                <div className="flex items-center justify-between mb-6">
                  <div 
                    onClick={() => navigate(servicesData[0].slug || servicesData[0].id)}
                    className="w-14 h-14 rounded-2xl bg-[#0a1438] border border-[var(--accent-blue)]/40 flex items-center justify-center text-[var(--accent-blue)] shadow-md cursor-pointer hover:border-[var(--accent-blue)] hover:scale-105 transition-all"
                    title={`View ${servicesData[0].title}`}
                  >
                ...
                <h3 
                  onClick={() => navigate(servicesData[0].slug || servicesData[0].id)}
                  className="font-display font-bold text-2xl sm:text-3xl text-white mb-3 hover:text-[var(--accent-blue)] transition-colors cursor-pointer"
                >
            ...
            <div className="lg:col-span-5 flex flex-col gap-6">
              ...
              >
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <div 
                      onClick={() => navigate(servicesData[1].slug || servicesData[1].id)}
                      className="w-12 h-12 rounded-xl bg-[#0a1438] border border-[var(--accent-blue)]/30 flex items-center justify-center text-[var(--accent-blue)] shadow-sm cursor-pointer hover:border-[var(--accent-blue)] hover:scale-105 transition-all"
                      title={`View ${servicesData[1].title}`}
                    >
                  ...
                  <h3 
                    onClick={() => navigate(servicesData[1].slug || servicesData[1].id)}
                    className="font-display font-bold text-xl text-white mb-2 hover:text-[var(--accent-blue)] transition-colors cursor-pointer"
                  >
              ...
              >
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <div 
                      onClick={() => navigate(servicesData[3].slug || servicesData[3].id)}
                      className="w-12 h-12 rounded-xl bg-[#0a1438] border border-[var(--accent-blue)]/30 flex items-center justify-center text-[var(--accent-blue)] cursor-pointer hover:border-[var(--accent-blue)] hover:scale-105 transition-all"
                      title={`View ${servicesData[3].title}`}
                    >
                  ...
                  <p className="text-xs sm:text-sm text-slate-300 leading-relaxed mb-4">
                    {servicesData[3].fullDesc}
                  </p>

                  <div className="space-y-1.5 mb-4">
                    {servicesData[3].deliverables.slice(0, 2).map((del, i) => (
            ...
            <div className="relative z-10 px-5 sm:px-6 py-3.5 bg-slate-50 border-b border-slate-200 flex flex-wrap items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                ...
                <a
                  ...
                  title={`Open ${selectedCaseStudy.domain} in new tab`}
                  className="flex items-center gap-2 px-3 py-1 rounded-lg bg-white border border-slate-200 hover:border-blue-300 text-xs font-mono shadow-xs transition-all group/address cursor-pointer"
                >
                  <Lock className="w-3.5 h-3.5 text-emerald-600" />
                  <span className="text-slate-400 select-none hidden sm:inline">https://</span>
                  <span className="text-blue-700 font-semibold group-hover/address:underline">{selectedCaseStudy.domain}</span>
                  <ExternalLink className="w-3 h-3 text-slate-400 group-hover/address:text-blue-700 transition-colors ml-0.5" />
                </a>
              </div>
